rule mothur_trim_seqs:
    ...
    shell:
        ...
        {params.mothur} "#set.dir(output={params.outdir});set.logfile(name={log},append=T);trim.seqs(fasta={input.fasta},maxambig={params.maxambig},maxhomop={params.maxhomop},minlength={params.minlen})" \
            >> {log} 2>&1
        """
